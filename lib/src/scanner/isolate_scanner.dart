...
class IsolateTLScanner {
  ...
  Future<void> scanWithIsolates(List<AssetFile> assets, Map<String, dynamic> packageResolverData) async {
  ...
  Future<void> processChunkInIsolate(List<AssetFile> chunk, Map<String, dynamic> packageResolverData) async {
